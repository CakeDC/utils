<?php
App::uses('Controller', 'Controller', false);
App::uses('Component', 'Utils.Referer');
...
if (!class_exists('ArticlesRefererTestController')) {
	class ArticlesRefererTestController extends Controller {

	/**
	* @var string
	* @access public
	*/
		public $name = ' ArticlesRefererTest';
...
class RefererTest extends CakeTestCase {
/**
 * Fixtures
 *
 * @var array
 ...
 */
	function setUp() {
		...
		$this->Controller = new ArticlesRefererTestController($request);
